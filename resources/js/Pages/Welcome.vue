    ...
    <div class="bg-gray-100 flex flex-column justify-center items-center h-screen">
        ...
        <div
            ...
            <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                ...
                <svg class="mr-3 w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 18 16">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3"></path>
                </svg>
                <div class="text-left">
                    <div class="mb-1 text-xs">Login</div>
                    <div class="-mt-1 font-sans text-sm font-semibold">Dashboard</div>
                </div>
                </Link>
            </div>
        </div>
