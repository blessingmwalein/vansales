...
export default {
    ...
    data() {
        return {
            ...
            deleteModal: null,
            warehouses_data: this.warehouses
        }
    },
    mounted() {
    ...
    methods: {
        ...
        deleteWarehouse() {
            this.$inertia.delete(`/company/warehouses/${this.selectedWarehouse.id}`, {
                preserveScroll: true,
                onSuccess: () => {
        ...
        openSingleWarehouse(warehouse) {
            this.$inertia.visit(`/company/warehouses/${warehouse.id}`)
        }
    },
...
<template>
    <MainLayout>
            ...
            <div class="overflow-x-auto">
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                        <TableLayout :hasData="warehouses_data.data.length > 0 ? true : false">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700"
                                            v-for="warehouse in warehouses_data.data">
                                            <td class="w-4 p-4">
                                                <div class="flex items-center">
                                                    <input :id="`checkbox-${warehouse.id}`" aria-describedby="checkbox-1"
                                                        type="checkbox"
                                                        class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                                    <label :for="`checkbox-${warehouse.id}`"
        ...
        <div  v-if="warehouses_data.data.length > 0"
