export default {
    data() {
        return {
            clientUser: this.$page.props.auth?.user,
        };
    },
    filters: {
        formatField(value) {
    ...
    methods: {
        isExternalUser() {
            console.log(this.clientUser.type);
            return this.clientUser?.type === "External";
        },
        //fire snackbar
        ...
        getLoadsheetChangedFromDescription(description) {
            ...
            const changesArray = Object.keys(changesObj).map((key) => ({
                [key]: changesObj[key],
            }));
            return changesArray;
        },
     ...
     formatDateTime(dateTimeString) {
        ...
        formatMoney (value) {
            ...
            const formattedValue = value.toLocaleString('en-US', {
              style: 'currency',
              currency: 'USD', // You can change the currency based on your requirements
              minimumFractionDigits: 2,
