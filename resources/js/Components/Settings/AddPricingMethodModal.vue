            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-semibold dark:text-white">
                        {{ pricingMethod ? "Edit Pricing Method" : 'Create Pricing Method' }}
                    </h3>
                    <button type="button"
...
export default {
    ...
    data() {
        return {
            form: useForm({
                name: this.pricingMethod?.name || '',
                id: this.pricingMethod?.id || null,
    ...
    watch: {
        // Watch the 'pricingMethod' prop for changes
        pricingMethod: {
            handler(newValue) {
                // Update the 'form' data when 'pricingMethod' prop changes
