<template>
    <div id="confirm-delivery-sheet-modal" tabindex="-1"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">To {{ type }} this delivery sheet
                        please
                        type this <strong class="dark:text-black-700">{{ deliverySheet.id }}</strong> in textbox
                        below?</h3>
                    <form>
                        <div class="mb-6">
                            <input type="text" id="email" @input="setValid" v-model="deliverySheetNumber"
...
export default {
    ...
    props: ['deliverySheet', 'type'],
    methods: {
        setValid() {

            if (this.deliverySheetNumber == this.deliverySheet.id) {
