                ...
                <div class="p-6 space-y-6">
                    <form action="#">
                        ...
                        <div>
                            ...
                            <textarea id="locations" rows="4" v-model="form.description"
...
export default {
    ...
    watch: {
        // Watch the 'productCategory' prop for changes
        productCategory: {
            handler(newValue) {
                // Update the 'form' data when 'productCategory' prop changes
