        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <button type="button" @click="toggleQuickLinks()"
                    ...
                    <div style="margin-top:450px"
                        class="origin-top-right absolute right-0 mt-6 mr-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200 hidden z-20 z-50 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 block"
                        ...
                        <div class="grid grid-cols-3 gap-4 p-4">
                            ...
                            <div class="text-sm font-medium text-gray-900 dark:text-white">Warehouses</div>
                            </Link>
                    ...
                    <div class="flex items-center ml-3">
                        <div>
                            <button type="button" @click="toggleProfile()"
                                ...
                                <img class="w-8 h-8 rounded-full" src="/assets/user.webp" alt="user photo">
                            </button>
                        </div>
                        <!-- Dropdown menu -->
...
export default {
    ...
    methods: {
        toggleQuickLinks() {
            const quickLinks = document.getElementById('apps-dropdown');
            //check if class hidden is present
            if (quickLinks.classList.contains('hidden')) {
        ...
        toggleProfile() {
            const quickLinks = document.getElementById('profile');
            //check if class hidden is present
            if (quickLinks.classList.contains('hidden')) {
                quickLinks.classList.remove('hidden');
            } else {
